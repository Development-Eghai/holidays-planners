        ...
        <div className="max-w-7xl mx-auto px-4 h-full">
          <div className="flex justify-between items-center h-full">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a
                href={`mailto:${pageData?.company?.emails?.[0]?.value || "info@holidaysplanners.com"}`}
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-black text-[#1A1A1A] group-hover:text-[#2D5D3F] leading-none">
                    {pageData?.company?.emails?.[0]?.value || "info@holidaysplanners.com"}
                  </span>
                </div>
              </a>
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-start pt-8 border-t border-gray-800 mt-8">
            <div className="flex flex-col items-center md:items-start">
              ...
              >
                <Mail size={18} /> {pageData?.company?.emails?.[0]?.value || "info@holidaysplanners.com"}
              </a>
            </div>
