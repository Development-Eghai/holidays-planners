...
const API_CONFIG = {
  API_URL: 'https://api.yaadigo.com/secure/api/destinations/',
    ...
    const fetchDestinations = async () => {
      try {
        ...
        const domestic = data
          ...
          .slice(0, 10)
          .map((d) => ({ label: d.title, href: `/destination/${d.slug}/${d.id}` }));
      ...
      <footer className="bg-gradient-to-b from-gray-900 to-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <FooterColumn title="Quick Links" links={quickLinks} delay={200} />
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 text-sm">
              <a href="mailto:info@holidaysplanners.com" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300">
              ...
              <a href="https://www.holidaysplanners.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300">
