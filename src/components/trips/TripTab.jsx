...
const tripDetailsData = {
  ...
  'kasol': {
    route: 'Delhi - Kasol - Kheerganga - Tosh - Manikaran - Delhi',
            ...
            >
              ...
              <header className="mb-4 border-b border-cyan-200 pb-2">
                ...
                <p className="text-gray-500 text-sm mt-0.5">
                  Inquiring about: <span className="font-bold text-cyan-700">{pricingData.name}</span>
                </p>
              </header>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-6 lg:self-start">
              ...
              {/* Book Now Section */}
              <div className="relative overflow-hidden bg-white rounded-xl shadow-2xl border-4 border-blue-500 animate-float" style={{ animationDelay: '0.5s' }}>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 font-medium">Reserve your spot</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-5 mb-4 border-2 border-cyan-200">
                    <div className="text-center">
                      ...
                      <p className="text-4xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent">
                        ₹{Math.min(...Object.values(pricingData.prices)).toLocaleString()}
                      </p>
